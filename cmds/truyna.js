exports.run = async (message, args)=> {
  ...
  banlogchannel.send("**" + name + "** đã Truy Nã **" + username + "** `(ID steam: "+ steamid + ")` Thời gian: `" +thoigian + " phút` ( Lý Do Truy Nã: *" + lydo + "* ) Vào Lúc `" + timenow + '` ');
  message.reply(":white_check_mark: **TRUY NÃ THÀNH CÔNG ** :white_check_mark: ");
}
