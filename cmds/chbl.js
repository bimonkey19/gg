exports.run = async (message, args)=> {
  ...
  if ((!args[1]) || (!args[2]) || (!args[3]) ) 
    return  message.reply(":warning: :warning: **SAI CÚ PHÁP**:warning: :warning: \n *Tạo BlackList*:     `.CHBL [Link steam] [Số ngày blacklist (không quá 30 ngày)] [Lý Do]`");
  ...
  chbanlogchannel.send("**" + name + "** đã Blacklist  **" + username + "** `(ID steam: "+ steamid + ")` Thời Gian: `" + timestart +" - "+ timeend + "` ( Lý Do Blacklist: *" + lydo + "* ) Vào Lúc:  `" + timenow + '` ');
