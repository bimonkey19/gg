exports.run = async (message, args)=> {
  ...
  banlogchannel.send ("**" + name + "** đã gỡ Blacklist **" + check[0].username + "** (`ID steam: "+ check[0].steamid + " (` Lý Do: *" + lydo + "* ) Vào Lúc `" + timenow + '` ');
  message.reply(":white_check_mark: **GỠ BLACKLIST THÀNH CÔNG** :white_check_mark: ");
}
